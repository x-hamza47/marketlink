...
import { useOrderAnalytics } from '@/features/admin/useOrderAnalytics'
...
export default function OrderAnalyticsChart() {
  ...
  const { data, isLoading } = useOrderAnalytics(range)

  return (
    <Surface className="p-5">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h2 className="font-display text-lg font-medium text-text-main">Order Analytics</h2>
          <p className="text-xs text-text-secondary mt-0.5">Orders placed over time</p>
        </div>
